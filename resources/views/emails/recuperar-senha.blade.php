                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;width:100%;">
                    ...
                    <tr>
                        <td style="background-color:#2563eb;padding:32px 40px;text-align:center;">
                            <h1 style="margin:0;color:#ffffff;font-size:24px;font-weight:700;letter-spacing:-0.5px;">Workinhoo</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:40px;">
                                ...
                                <tr>
                                    <td align="center" style="padding:24px 0;">
                                        <div style="display:inline-block;background-color:#f0f4ff;border:2px dashed #2563eb;border-radius:8px;padding:20px 40px;">
                                            ...
                                            <p style="margin:0;color:#2563eb;font-size:36px;font-weight:700;letter-spacing:8px;">{{ $codigo }}</p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin:0 0 24px;color:#374151;font-size:15px;line-height:1.6;">
                                Este código expira em <strong>15 minutos</strong>. Caso não tenha solicitado a redefinição de senha, ignore este e-mail.
                            </p>
